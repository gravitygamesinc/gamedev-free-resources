...
📌 [Book Of The Dead: Environment](https://assetstore.unity.com/packages/essentials/tutorial-projects/book-of-the-dead-environment-hdrp-121175) -  This appears to be a tutorial project focusing on creating an environment for a game in Unity using the High-Definition Render Pipeline (HDRP).  
